  ...
  nodes: [
    {
      ...
      x: 24.5,
      y: 28.5,
      hitbox: { x: 25, y: 25, width: 31, height: 18 },
    },
    {
      id: "meadows",
      name: "Луга",
      ...
      x: 52,
      y: 31,
      hitbox: { x: 52, y: 28.5, width: 21, height: 17 },
    },
    {
      id: "forest",
      name: "Лес",
      ...
      x: 77,
      y: 35,
      hitbox: { x: 78, y: 32.5, width: 20, height: 18 },
    },
    {
      id: START_NODE_ID,
      name: "Болото",
      ...
      x: 47.2,
      y: 46.5,
      hitbox: { x: 47.2, y: 46.5, width: 27, height: 20 },
    },
    {
      id: "ruins",
      name: "Руины",
      ...
      x: 24.5,
      y: 68,
      hitbox: { x: 22, y: 68, width: 25, height: 19 },
    },
    {
      id: "settlement",
      name: "Поселение",
      ...
      x: 76.5,
      y: 69,
      hitbox: { x: 78, y: 70.5, width: 28, height: 20 },
    },
    {
      id: "dungeon",
      name: "Подземелье",
      ...
      x: 52,
      y: 92.5,
      hitbox: { x: 52, y: 91, width: 30, height: 17 },
    },
  ],
  edges: [
