  ...
  return (
    <section className="game-view" aria-labelledby="location-map-title">
      <div className="game-view__heading">
        ...
        <span className="location-badge"><span aria-hidden="true">◇</span>{location.worldName}</span>
      </div>
      ...
      <div className="map-frame">
        <div className="location-map" aria-label="Карта текущей локации">
          ...
          <div className="location-map__zone location-map__zone--one"><span>Лесная чаща</span></div>
          <div className="location-map__zone location-map__zone--two"><span>Заброшенные руины</span></div>
          <div className="location-map__zone location-map__zone--three"><span>Каменные холмы</span></div>
          <div className="location-map__zone location-map__zone--four"><span>Туманные топи</span></div>
          <div
