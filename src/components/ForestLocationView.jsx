...
const forestPoints = [
  {
    ...
    y: 25.66,
    description:
      "Старая каменная арка почти полностью заросла мхом. За ней начинается узкая тропа, уходящая глубже в лес.",
  },
  {
    ...
    y: 21.69,
    description:
      "Исполинское дерево возвышается над лесом. Его корни оплели камни, а кора покрыта необычными узорами.",
  },
  {
  ...
  },
  {
    ...
    y: 55.59,
    description:
      "Старый деревянный мост перекинут через ручей. Доски скрипят, но пока выдерживают вес путника.",
  },
  {
...
const FOREST_ASPECT_RATIO = 800 / 600;
